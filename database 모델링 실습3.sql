...
insert into `Users` values ('user5','장보고','1966-09-12','M','010-2104-1966','janbg@naver.com','9400','4','대전',now());
insert into `Users` values ('user6','선덕여왕','1979-07-28','M','010-3101-1979','gueen@naver.com','1600','2','대전',now());
insert into `Users` values ('user7','강감찬','1984-06-15','F','010-4101-1984','kang@daum.com','800','0','대구',now());
...
insert into `Users` values ('user10','허난설헌','1992-09-07','M','010-7103-1992',null,'4100','3','광주',now());
...
insert into `Products` values ('130112','13','10006','중대형 사계정 강아지옷','120','15000','80','0');
